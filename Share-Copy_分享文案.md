...
它是一个面向长文、学习材料和严肃内容的低阻力阅读辅助工具，不需要登录，也不会上传文字。你可以把文章、论文、课程材料、文档或长邮件复制进去，它会放大显示，可以朗读，也可以关闭声音只保留高亮导读。
